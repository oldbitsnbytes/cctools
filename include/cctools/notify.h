...
//  intellectual proprietary to:
// https://schneegans.github.io/tutorials/2015/09/20/signal-slot :
//
// Modified and adapted for catui and implement in basic threads, by oldlonecoder
// Not using any forward, r-value move, in-place std::functional. Thus, notify instance must be held in a unique location and not be moved.
// ------------------------------------------------------------------
